...
class Particle {
    constructor(x, y, color) {
        ...
        this.color = color;
        this.alpha = 1;
        this.curveOffset = Math.random() * 10; // Randomize curve offset
        this.curveDirection = Math.random() < 0.5 ? 1 : -1; // Randomize curve direction
    }

    update() {
        this.x += Math.cos(this.angle) * this.speed;
        this.y += Math.sin(this.angle) * this.speed;
        this.y += Math.sin(this.curveOffset) * this.curveDirection; // Add curvy effect
        this.alpha -= 0.01;
        this.curveOffset += 0.1; // Increment curve offset for animation
    }
